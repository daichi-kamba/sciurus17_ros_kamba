...
// *********************************************************
//
// File autogenerated for the sciurus17_msgs package
// by the dynamic_reconfigure package.
// Please do not edit.
//
// ********************************************************/

#ifndef __sciurus17_msgs__SERVOPARAMETERCONFIG_H__
#define __sciurus17_msgs__SERVOPARAMETERCONFIG_H__
...
namespace sciurus17_msgs
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(ServoParameterConfig &config, const ServoParameterConfig &max, const ServoParameterConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const ServoParameterConfig &config1, const ServoParameterConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, ServoParameterConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const ServoParameterConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, ServoParameterConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const ServoParameterConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const ServoParameterConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, ServoParameterConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
