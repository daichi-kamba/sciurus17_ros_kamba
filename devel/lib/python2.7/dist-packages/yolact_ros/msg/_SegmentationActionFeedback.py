...
"""autogenerated by genpy from yolact_ros/SegmentationActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class SegmentationActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "yolact_ros/SegmentationActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','yolact_ros/SegmentationFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SegmentationActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = yolact_ros.msg.SegmentationFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = yolact_ros.msg.SegmentationFeedback()
