...
def change_coord_callback2(rgb_image,dep_image):
	...
	try:
		...
		print e  
	click_and_select(color_image,"change_coord",1,1,1)
...
def camera_to_world_on_tf(cc):
	...
	l.waitForTransform("base_link","object_point",now, rospy.Duration(0.1))
